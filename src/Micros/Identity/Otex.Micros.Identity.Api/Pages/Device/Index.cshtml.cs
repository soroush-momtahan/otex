...
using Otex.Micros.Identity.Api.Pages.Consent;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Microsoft.Extensions.Options;

namespace Otex.Micros.Identity.Api.Pages.Device;
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken ct)
    {
        var request =
            await _interaction.GetAuthorizationContextAsync(
                Input.UserCode ?? throw new ArgumentNullException(nameof(Input.UserCode)), ct);
        if (request == null)
        {
