...
namespace Otex.Micros.Identity.Api.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(CancellationToken ct)
    {
        ...
        await _events.RaiseAsync(
            new UserLoginSuccessEvent(provider, providerUserId, user.Id, user.UserName, true, context?.Client.ClientId),
            ct);
