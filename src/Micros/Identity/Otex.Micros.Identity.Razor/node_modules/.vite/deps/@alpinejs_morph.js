...
function createMorphContext(options = {}) {
	...
	context.patchChildren = function(from, to) {
		...
		while (currentTo) {
			...
			if (currentFrom._x_lastRenderedEl) currentFromNext = getNextSibling(from, currentFrom._x_lastRenderedEl);
...
//#endregion
export { module_default as default, src_default as morph };
